// ✅ RouteDetailSliverAppBar (Category versiyonuna uyarlanmış)
...
class RouteDetailSliverAppBar extends StatelessWidget {
  final ThemeProvider themeProvider;
  final RouteDetailPageViewModel viewModel;
  final double appBarHeight;
  final double expandedHeight;

  const RouteDetailSliverAppBar({
    super.key,
      ...
      flexibleSpace: ClipRRect(
        ...
        child: FlexibleSpaceBar(
          ...
          background: Padding(
            ...
            child: Hero(
              tag: 'route_${viewModel.route.title}',
              child: ClipRRect(
                borderRadius: const BorderRadius.only(
                  bottomLeft: Radius.circular(24),
                  bottomRight: Radius.circular(24),
